...
export class V1 {
	...
	async get<T>(path: string, config?: AxiosRequestConfig): Promise<AxiosResponse<T & APIResultBase>> {
	...
	async post<T>(path: string, body: any, config?: AxiosRequestConfig): Promise<AxiosResponse<T & APIResultBase>> {
